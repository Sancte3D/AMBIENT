# EXC80W32 TOUCH SCREEN CONROLLER BSP Component Driver MCU Software Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32-exc80w32.svg?color=brightgreen)
...
This repository provides the STM32Cube **EXC80W32** BSP Component Driver, **common to every** STM32Cube MCU firmware that supports it.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-exc80w32/blob/main/Release_Notes.html).
