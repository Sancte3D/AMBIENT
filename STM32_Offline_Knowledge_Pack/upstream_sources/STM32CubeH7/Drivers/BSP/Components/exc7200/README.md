...
This **exc7200** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **EXC7200** BSP TOUCH SCREEN component part.
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/exc7200/blob/main/Release_Notes.html).
...
If you have any issue with the **software content** of this repository, you can file an issue [here](https://github.com/STMicroelectronics/exc7200/issues/new/choose).
