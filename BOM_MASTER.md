...
| **D3B** USB-Pfad-Schottky (Dioden-OR, r18.79) | **SS34** 40 V 3 A | [C8678](https://www.lcsc.com/product-detail/C8678.html) (gleicher Code wie D3, Qty 2) | `Diode_SMD:D_SMA` | KiCad-Standard | Standard-Lib-3D |
...
> - `BAT_PLUS` (LiPo) → boost **U8** (4,97 V, r18.79-korrigierter FB-Teiler) → **D3** ──┤→ **`+5V_RAIL`** (Dioden-OR, r18.79; USB-Zweig: VBUS → F1 → **D3B**) — feeds amp U4 + U_PWR
