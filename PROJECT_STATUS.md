...
| **Szenen-Regressionstest** | ✅ `test/test_ui_scene.c` — jede Szene zeichnet bei jedem Wert, bleibt in ihrer Box und reagiert sichtbar auf **jede** ihrer Eigenschaften. Fand den Pitch-Referenzring, der aus der Box lief |
