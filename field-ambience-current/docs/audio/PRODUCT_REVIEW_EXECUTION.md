...
| Klangwelt | Open-Sea-Grundton korrigiert und Stimme/Pad/Raum getrennt verglichen. Automatisches Register auf D3..A4 gesenkt. Chorus/Blur-Auslöschungen begrenzt (`CALM_MOTION_REVIEW.md`). Jetzt Horn/Bowed-Resonanzen/Vibrato, danach kombinierte Tonhöhenbewegung und Shimmer-Nutzen. | Aktive Priorität; keine zusätzlichen Synths. |
