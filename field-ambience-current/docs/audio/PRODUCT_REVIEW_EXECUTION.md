...
| Klangwelt | Open-Sea-Grundton korrigiert und Stimme/Pad/Raum getrennt verglichen. Automatisches Register auf D3..A4 gesenkt. Chorus/Blur-Auslöschungen begrenzt (`CALM_MOTION_REVIEW.md`). Alps-Quelle umgebaut (`ALPS_BODY_REVIEW.md`); jetzt Bowed-Bogenrauschen/Vibrato, dann Choir/Forest und Guembri/Desert. | Aktive Priorität; keine zusätzlichen Synths. |
