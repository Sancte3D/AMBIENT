...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/brain.c" "$src/src/worlds.c" "$src/src/generative.c" "$src/src/cells.c" "$src/src/engine.c" "$src/src/body.c" "$src/src/composer.c" "$src/src/pluck.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/generative.c" \
    "$src/src/cells.c" \
    "$src/src/engine.c" "$src/src/body.c" "$src/src/composer.c" "$src/src/pluck.c" \
