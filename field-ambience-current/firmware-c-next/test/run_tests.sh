...
"$CC" "${CFLAGS[@]}" \
    "$here/test_pad.c" \
    "$src/src/dsp.c" \
    "$src/src/dsp_ladder.c" "$src/src/pad.c" "$src/src/padsynth.c" \
    -lm -o "$tmp/pad_test"
"$tmp/pad_test"
...
# r19.29: minimal-movement voice leading (pure integer)
"$CC" "${CFLAGS[@]}" \
    "$here/test_voicelead.c" \
    "$src/src/voicelead.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/controls.c" \
    "$src/src/dsp.c" "$src/src/dsp_ladder.c" "$src/src/pad.c" "$src/src/padsynth.c" "$src/src/texture.c" "$src/src/ambience.c" "$src/src/tape.c" "$src/src/echo.c" "$src/src/blur.c" "$src/src/bass.c" \
    "$src/src/drone.c" "$src/src/reverb.c" "$src/src/reverb_presets.c" \
    "$src/src/brain.c" "$src/src/worlds.c" "$src/src/generative.c" "$src/src/cells.c" "$src/src/engine.c" "$src/src/fx_master.c" "$src/src/ambient_effects.c" "$src/src/body.c" "$src/src/composer.c" "$src/src/harmony.c" "$src/src/tuning.c" "$src/src/pluck.c" "$src/src/glass.c" "$src/src/ember.c" "$src/src/bowed.c" "$src/src/horn.c" "$src/src/shimmer.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/pluck.c" "$src/src/glass.c" "$src/src/ember.c" "$src/src/bowed.c" "$src/src/horn.c" "$src/src/shimmer.c" "$src/src/tape.c" \
    "$src/src/dsp.c" "$src/src/dsp_ladder.c" "$src/src/pad.c" "$src/src/padsynth.c" "$src/src/texture.c" "$src/src/ambience.c" "$src/src/echo.c" "$src/src/blur.c" "$src/src/bass.c" \
    "$src/src/drone.c" "$src/src/reverb.c" "$src/src/reverb_presets.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/generative.c" \
    "$src/src/cells.c" \
    "$src/src/engine.c" "$src/src/fx_master.c" "$src/src/ambient_effects.c" "$src/src/body.c" "$src/src/composer.c" "$src/src/harmony.c" "$src/src/tuning.c" "$src/src/pluck.c" "$src/src/glass.c" "$src/src/ember.c" "$src/src/bowed.c" "$src/src/horn.c" "$src/src/shimmer.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/body.c" "$src/src/composer.c" "$src/src/harmony.c" "$src/src/tuning.c" "$src/src/pluck.c" "$src/src/glass.c" "$src/src/ember.c" "$src/src/bowed.c" "$src/src/horn.c" "$src/src/shimmer.c" "$src/src/audio_profiler.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/dsp.c" "$src/src/dsp_ladder.c" "$src/src/pad.c" "$src/src/padsynth.c" "$src/src/texture.c" "$src/src/ambience.c" "$src/src/tape.c" "$src/src/echo.c" "$src/src/blur.c" "$src/src/bass.c" \
    "$src/src/drone.c" "$src/src/reverb.c" "$src/src/reverb_presets.c" "$src/src/brain.c" "$src/src/worlds.c" "$src/src/generative.c" "$src/src/cells.c" "$src/src/engine.c" "$src/src/fx_master.c" "$src/src/ambient_effects.c" \
    "$src/src/body.c" "$src/src/composer.c" "$src/src/harmony.c" "$src/src/tuning.c" "$src/src/pluck.c" "$src/src/glass.c" "$src/src/ember.c" "$src/src/bowed.c" "$src/src/horn.c" "$src/src/shimmer.c" \
...
# r19.41: master-effects engine property suite (bit-exact bypass, block-
# partition invariance, arena guards, delay timing, long tails, reverse
# alignment, parameter stress) — the handoff's verification adapted into
# this runner. Same sources the product links (src/ambient_effects.c).
"$CC" "${CFLAGS[@]}" -Wno-conversion \
    "$src/../effects-engine/tests/effects_verify.c" \
    "$src/src/ambient_effects.c" \
    -lm -o "$tmp/ambient_fx_test"
"$tmp/ambient_fx_test"
