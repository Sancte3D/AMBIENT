...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/brain.c" "$src/src/worlds.c" "$src/src/generative.c" "$src/src/cells.c" "$src/src/engine.c" "$src/src/body.c" "$src/src/pluck.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/drone.c" "$src/src/reverb.c" "$src/src/reverb_presets.c" \
    "$src/src/brain.c" "$src/src/worlds.c" "$src/src/generative.c" "$src/src/cells.c" "$src/src/engine.c" "$src/src/body.c" \
...
"$CC" "${CFLAGS[@]}" \
    ...
    "$src/src/generative.c" \
    "$src/src/cells.c" \
    "$src/src/engine.c" "$src/src/body.c" "$src/src/pluck.c" \
